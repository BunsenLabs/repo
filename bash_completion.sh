...
_apt_sourcemgr () {
  ...
  local dashed="-F --file  -D --disabled  -E --enabled  -I --invalid  -a --architecture  -c --component  -d --distribution  -f --fuzzy -h --help -r --regex  -t --type  -u --uri  -s --simulate  -T --template"
